    ...
    public class UserCompanyAddressValidator : AbstractValidator<UserCompanyAddressViewModel>
    {
        public UserCompanyAddressValidator()
        {
            RuleFor(x => x.City)
               ...
               .WithMessage(string.Format("Pole Miasto może mieć maksymalnie {0}", Validations.MaximumLength.CityNameLength));
            ...
            RuleFor(x => x.StreetName)
               ...
               .WithMessage(string.Format("Pole Ulica może mieć maksymalnie {0}", Validations.MaximumLength.StreetNameLength));
            ...
            RuleFor(x => x.StreetNumber)
               ...
               .WithMessage(string.Format("Pole Numer może mieć maksymalnie {0}", Validations.MaximumLength.StreetNumberLength));
            ...
            RuleFor(x => x.ZIPCode)
               ...
               .WithMessage(string.Format("Pole Kod Pocztowy może mieć maksymalnie {0}", Validations.MaximumLength.ZIPCodeLength));

            RuleFor(x => x.PlaceNumber)
               .Cascade(CascadeMode.StopOnFirstFailure)
               .Length(0, Validations.MaximumLength.PlaceNumberLength)
               .WithMessage(string.Format("Pole Numer Lokal może mieć maksymalnie {0}", Validations.MaximumLength.PlaceNumberLength));
        }
    }
}