...
* 		timeThreshold 	int  		Default 250. Time, in milliseconds, between touchStart and touchEnd must not exceed in order to be considered a swipe.
...
(function ($) {
    $.fn.swipe = function (options) {
        ...
        var defaults = {
            ...
            timeThreshold: 500,      // int - Time, in milliseconds, between touchStart and touchEnd must not exceed in order to be considered a swipe.
